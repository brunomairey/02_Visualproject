            ...
            <div class='card-body rounded'>
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off"
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control col-md-12 mb-3" placeholder="Your Email"
                               value="<?php echo $email; ?>" maxlength="40" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="pass" class="form-control col-md-12 mb-3"
                               placeholder="Your Password" maxlength="15">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <button type="button" class="col-md-4 btn btn-secondary"><a
                                    style="text-decoration: none; color: white;" href="user/register.php">Sign Up
                                Here...</a></button>
                    </div>
