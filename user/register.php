...
?>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="on"
        ...
        <div class="form-group">
            ...
            <label>Name</label>
            <input type="text" name="name" class="form-control col-md-6 mb-3" placeholder="Enter Name" maxlength="50"
                   value="<?php echo $name ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" name="lastname" class="form-control col-md-6 mb-3" placeholder="Enter Lastname"
                   maxlength="50" value="<?php echo $lastname ?>">

            <span class="text-danger"> <?php echo $lastnameError; ?> </span>
        </div>
        <div class="form-group">
            <label>Email address</label>
            <input type="email" name="email" class="form-control col-md-6 mb-3" placeholder="Enter Your Email"
        ...
        <div class="form-group">
            ...
            <input type="password" name="pass" class="form-control col-md-6 mb-3" placeholder="Enter Password"
                   maxlength="15">
        ...
        <div class="form-group">
            ...
            <input type="password" name="repass" class="form-control col-md-6 mb-3" placeholder="reenter Password"
                   maxlength="15">
        ...
        <a href="../index.php">
            <button type="button" class=" btn btn-secondary">Sign in Here...</button>
        </a>
