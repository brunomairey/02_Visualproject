            ...
            <form class="contact-form" action="updateressource.php" method="POST" id="edit-form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ressource_name" name="ressource_name" class="form-control"
                               placeholder="Enter the name of the ressource">
                    </div>

                    <div class="form-group">
                        <label>Type of ressources</label><h6 id="ressource_type-info" class="text-danger"></h6>
                        <input type="text" id="ressource_type" name="ressource_type" class="form-control"
                               placeholder="Enter the type of ressources">
                    </div>
