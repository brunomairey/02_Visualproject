...
<main>
                    ...
                    <div style="position: relative; top:0; background-color: grey">
                        ...
                        <tr class="complex-top">
                            ...
                            <th class="first" colspan="6">
                                <div class="th-inner">ressources</div>
                            </th>
                            <!-- Button trigger modal -->
                            <th class="first" colspan="4">
                                <div class="th-inner">
                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                            data-target="#addaressource" style="cursor: pointer;">Add a ressource
                                    </button>
                                </div>

                            </th>
                            <th colspan="4" class="second text-center">
                                <div class="th-inner"> November 2020</div>
                            </th>
                            <th colspan="5" class="second text-center">
                                <div class="th-inner"> December 2020</div>
                            </th>
                            <th colspan="4" class="second text-center">
                                <div class="th-inner"> Jan 2021</div>
                            </th>
                            <th colspan="4" class="second text-center">
                                <div class="th-inner"> Feb 2021</div>
                            </th>
                            <th colspan="5" class="second text-center">
                                <div class="th-inner"> March 2021</div>
                            </th>
                            <th colspan="4" class="second text-center">
                                <div class="th-inner"> April 2021</div>
                            </th>
                        </tr>
                        <tr class="complex-bottom">
                            <th class="first text-center" colspan="10">
                                <div class="th-inner">Week number</div>
                            </th>
    ...
    <!-- End of container for ressources -->

    <?php include 'insertmodalressource.php'; ?>
    <?php include 'updatemodalressource.php'; ?>
    <?php include 'deletemodalressource.php'; ?>
