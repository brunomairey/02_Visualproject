...
<div style="position: relative; top:0; background-color: grey">
   ...
   <thead > <tr class="complex-top">
    ...
    <th class="first" colspan="6">
      <div class="th-inner">ressources   </div></th>
<!-- Button trigger modal -->
  <th class="first" colspan="4"><div class="th-inner">
<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addaressource" style="cursor: pointer;">Add a ressource</button></div>
