    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" id="ressource-name" name="ressource_name" class="form-control" placeholder="Enter the name of the ressource">
			  </div>

				  <div class="form-group">
			    <label>Type of the ressource</label><h6 id="ressource-type-info" class="text-danger"></h6>
			    <input type="text" id="ressource-type" name="ressource_type" class="form-control" placeholder="Enter the type of the ressource">
			  </div>
