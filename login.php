        ...
        <div class='card border-light rounded my-auto'>
          ...
          <div class='card-body rounded'>
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
              ...
              <hr />
              <button class="btn btn-light btn-lg  mr-5 my-2 button" type="submit" name="btn-login">Log In</button>


              <hr />

             <!--  <a href="register.php">Sign Up Here...</a> -->
              <a href="user/register.php"><button class="btn btn-outline-light" type="button">Sign Up Here...</button></a>
